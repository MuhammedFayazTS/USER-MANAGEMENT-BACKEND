...
export const loginWithTempPassTemplate = (
  url: string,
  email: string,
  tempPassword: string,
  brandName: string,
  ...
  subject: `Login to ${brandName}`,
  text: `To login to ${brandName}, please click the following link: ${url}`,
  html: `
  <html>
  <head>
    <style>
  ...
  <body>
    <div class="container">
      <div class="header">NexusFlow</div>
      <div class="content">
        ...
        <p>
          Please click the button below to log in. We recommend changing your password after logging in for the first time.
        </p>
        <a href="${url}" class="button">Login to ${brandName}</a>
        <p>
          If you did not request this, please disregard this email or contact our support team.
        </p>
      </div>
      <div class="footer">
        <p>
